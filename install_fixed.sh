...
# Fixed Media Pipeline Installation Script
# This script fixes the permission issues and provides a robust installation
...
# Log script start
log_to_file "=== Fixed Media Pipeline Installation Started ==="
...
log "Starting Fixed Media Pipeline Installation..."
...
# Fix configuration file to use absolute paths
log "Fixing configuration file..."
$SUDO_CMD sed -i "s|log_dir: \"logs\"|log_dir: \"$LOG_DIR\"|g" "$PROJECT_DIR/config.yaml"
...
log "Fixed installation script completed!"
